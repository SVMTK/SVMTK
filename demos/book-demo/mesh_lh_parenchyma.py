...
if __name__ =='__main__':
        ...
        parser.add_argument("--pial"       ,type=argparse.FileType('r'), help = "The path to the pial surface", required=True)
        parser.add_argument("--white"      ,type=argparse.FileType('r'), help = "The path to the white surface",required=True)
        parser.add_argument("--ventricle"  ,type=argparse.FileType('r'), help = "The path to the ventricle surface",required=True)
